      ...
      <nav class="navbar navbar-expand-lg nav">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent6">
            ...
            <div class="d-flex">
              <a class=" utente text-light border border-2 border-light rounded-circle d-flex align-items-center justify-content-center ms-2"style="height:32px;width:32px;" href="profilo.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
